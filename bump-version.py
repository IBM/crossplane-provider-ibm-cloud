...
BUNDLE_CSV_YAML = "./bundle/manifests/ibm-crossplane-provider-ibm-cloud-operator.clusterserviceversion.yaml"
MANAGER_YAML = "./config/manager/manager.yaml"
CSV_YAML = "./config/manifests/bases/ibm-crossplane-provider-ibm-cloud-operator.clusterserviceversion.yaml"
README = "./README.md"
