...
CONTROLLER_IMAGE="${BUILD_REGISTRY}/ibm-crossplane-${PROJECT_NAME}-operator:${VERSION}-${SAFEHOSTARCH}"

version_tag="$(cat ${projectdir}/_output/version)"
# tag as latest version to load into kind cluster
PACKAGE_CONTROLLER_IMAGE="${DOCKER_REGISTRY}/ibm-crossplane-${PROJECT_NAME}-operator:${VERSION}"
