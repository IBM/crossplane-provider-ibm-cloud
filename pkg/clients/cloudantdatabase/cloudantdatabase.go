...
func IsUpToDate(in *v1alpha1.CloudantDatabaseParameters, observed *cv1.DatabaseInformation, l logging.Logger) (bool, error) {
	...
	diff := (cmp.Diff(desired, actual,
		cmpopts.EquateEmpty(),
		cmpopts.IgnoreFields(v1alpha1.CloudantDatabaseParameters{}, "CloudantAdminURL", "CloudantAdminURLRef", "CloudantAdminURLSelector"), cmpopts.IgnoreTypes(&runtimev1.Reference{}, &runtimev1.Selector{}, []runtimev1.Reference{})))
